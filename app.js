...
/* ---- Tools ---- */
solderiron:'<svg viewBox="0 0 64 64"><rect x="20" y="6" width="24" height="24" rx="8" fill="#1f2937"/><rect x="24" y="10" width="16" height="4" rx="2" fill="#374151"/><rect x="28" y="28" width="8" height="20" fill="#9ca3af"/><path d="M28 48 L36 48 L32 58 Z" fill="#d1d5db"/><circle cx="32" cy="57" r="2.5" fill="#f59e0b"/></svg>',
solderwire:'<svg viewBox="0 0 64 64"><circle cx="32" cy="32" r="22" fill="#9ca3af"/><circle cx="32" cy="32" r="10" fill="#4b5563"/><path d="M14 22 a18 18 0 0 1 36 0" stroke="#d4af37" stroke-width="4" fill="none" stroke-linecap="round"/><circle cx="32" cy="32" r="4" fill="#1f2937"/></svg>',
multimeter:'<svg viewBox="0 0 64 64"><rect x="14" y="10" width="36" height="44" rx="6" fill="#f59e0b"/><rect x="19" y="16" width="26" height="14" rx="2" fill="#1f2937"/><text x="32" y="26" font-size="8" text-anchor="middle" fill="#4ade80" font-family="monospace">3.3V</text><circle cx="32" cy="42" r="8" fill="#374151"/><rect x="30" y="34" width="4" height="8" fill="#d1d5db"/><path d="M22 54 q0 8 -4 12" stroke="#111" stroke-width="3" fill="none"/><path d="M42 54 q0 8 4 12" stroke="#e63c2f" stroke-width="3" fill="none"/></svg>',
stripper:'<svg viewBox="0 0 64 64"><path d="M20 10 L30 34 L18 40 L10 16 Z" fill="#e63c2f"/><path d="M44 10 L34 34 L46 40 L54 16 Z" fill="#e63c2f"/><rect x="26" y="32" width="4" height="4" fill="#9ca3af"/><rect x="34" y="32" width="4" height="4" fill="#9ca3af"/><path d="M22 40 L28 58" stroke="#1f2937" stroke-width="7" stroke-linecap="round"/><path d="M42 40 L36 58" stroke="#1f2937" stroke-width="7" stroke-linecap="round"/></svg>',
flushcutter:'<svg viewBox="0 0 64 64"><path d="M26 8 L38 8 L34 34 L30 34 Z" fill="#9ca3af"/><circle cx="32" cy="34" r="4" fill="#4b5563"/><path d="M24 38 L18 60" stroke="#2563eb" stroke-width="8" stroke-linecap="round"/><path d="M40 38 L46 60" stroke="#2563eb" stroke-width="8" stroke-linecap="round"/></svg>',
crimper:'<svg viewBox="0 0 64 64"><path d="M20 8 L44 8 L40 28 L24 28 Z" fill="#4b5563"/><rect x="27" y="20" width="10" height="8" fill="#1f2937"/><path d="M22 30 L14 58" stroke="#e63c2f" stroke-width="8" stroke-linecap="round"/><path d="M42 30 L50 58" stroke="#e63c2f" stroke-width="8" stroke-linecap="round"/><circle cx="32" cy="30" r="3" fill="#d4af37"/></svg>',
helphands:'<svg viewBox="0 0 64 64"><ellipse cx="32" cy="56" rx="20" ry="5" fill="#4b5563"/><rect x="30" y="20" width="4" height="36" fill="#6b7280"/><circle cx="46" cy="24" r="10" fill="none" stroke="#9ca3af" stroke-width="2"/><circle cx="46" cy="24" r="7" fill="#dbeafe" opacity=".5"/><path d="M18 22 l8 6 l-4 6 l-8 -6 Z" fill="#facc15"/><path d="M12 34 l8 4 l-3 6 l-8 -4 Z" fill="#facc15"/></svg>',
gluegun:'<svg viewBox="0 0 64 64"><rect x="12" y="18" width="32" height="14" rx="4" fill="#f59e0b"/><rect x="40" y="20" width="14" height="6" rx="2" fill="#9ca3af"/><path d="M20 32 L16 54 L24 54 L26 32 Z" fill="#374151"/><rect x="10" y="14" width="10" height="8" rx="2" fill="#d1d5db"/></svg>',
heatshrink:'<svg viewBox="0 0 64 64"><rect x="12" y="24" width="10" height="20" rx="3" fill="#e63c2f"/><rect x="24" y="24" width="10" height="20" rx="3" fill="#facc15"/><rect x="36" y="24" width="10" height="20" rx="3" fill="#16a34a"/><rect x="48" y="24" width="6" height="20" rx="3" fill="#2563eb"/></svg>',
heatgun:'<svg viewBox="0 0 64 64"><rect x="10" y="16" width="28" height="16" rx="4" fill="#374151"/><rect x="38" y="19" width="14" height="10" fill="#9ca3af"/><path d="M20 32 L16 54 L26 54 L24 32 Z" fill="#1f2937"/><path d="M54 20 q6 4 0 8" stroke="#f59e0b" stroke-width="2" fill="none"/><path d="M54 26 q8 4 0 8" stroke="#f59e0b" stroke-width="2" fill="none"/></svg>',
screwdriver:'<svg viewBox="0 0 64 64"><rect x="24" y="6" width="16" height="24" rx="6" fill="#facc15"/><rect x="30" y="28" width="4" height="24" fill="#9ca3af"/><path d="M28 52 L36 52 L32 58 Z" fill="#6b7280"/></svg>',
esdstrap:'<svg viewBox="0 0 64 64"><rect x="16" y="14" width="20" height="10" rx="5" fill="#1f2937"/><circle cx="26" cy="19" r="2.5" fill="#d4af37"/><path d="M36 20 q10 4 10 16 q0 10 8 14" stroke="#374151" stroke-width="3" fill="none"/><circle cx="54" cy="50" r="3" fill="#9ca3af"/></svg>',
desolderwick:'<svg viewBox="0 0 64 64"><rect x="10" y="12" width="18" height="18" rx="3" fill="#f59e0b"/><path d="M14 30 q4 8 -2 14" stroke="#9ca3af" stroke-width="3" fill="none"/><rect x="34" y="20" width="10" height="26" rx="5" fill="#1f2937"/><rect x="36" y="14" width="6" height="8" fill="#6b7280"/></svg>',
safetyglasses:'<svg viewBox="0 0 64 64"><circle cx="20" cy="32" r="12" fill="none" stroke="#374151" stroke-width="3"/><circle cx="44" cy="32" r="12" fill="none" stroke="#374151" stroke-width="3"/><circle cx="20" cy="32" r="10" fill="#dbeafe" opacity=".5"/><circle cx="44" cy="32" r="10" fill="#dbeafe" opacity=".5"/><path d="M32 30 h0" stroke="#374151" stroke-width="3"/><path d="M8 28 q-4 2 -4 8" stroke="#374151" stroke-width="3" fill="none"/><path d="M56 28 q4 2 4 8" stroke="#374151" stroke-width="3" fill="none"/></svg>'
};
